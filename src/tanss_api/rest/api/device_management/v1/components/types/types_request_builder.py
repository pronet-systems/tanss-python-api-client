...
class TypesRequestBuilder(BaseRequestBuilder):
    """
    Builds and executes requests for operations under /api/deviceManagement/v1/components/types
    """
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/api/deviceManagement/v1/components/types", path_parameters)
    
    def by_type_id(self,type_id: int) -> WithTypeItemRequestBuilder:
        """
        Gets an item from the tanss_api.rest.api.deviceManagement.v1.components.types.item collection
        param type_id: Unique identifier of the item
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[TypesGetResponse]:
        """
        Liefert alle Komponenten-Typen. Nicht in der offiziellen Schnittstellenbeschreibung gefuehrt; vom Server so umgesetzt, gegen 10.10 geprueft. Token: module, Rollen DEVICE_MANAGEMENT. Hinweise: Alias /api/v1/components/types. Kein Rechte-/Lizenz-Check. Neben den Feldern von TnsComponentType liefert der Server zusätzlich peripheryTypeId und fields.
