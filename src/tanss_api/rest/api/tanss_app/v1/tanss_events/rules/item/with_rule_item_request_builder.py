...
class WithRuleItemRequestBuilder(BaseRequestBuilder):
    """
    Builds and executes requests for operations under /api/tanss.app/v1/tanssEvents/rules/{ruleId}
    """
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/api/tanss.app/v1/tanssEvents/rules/{ruleId}", path_parameters)
    ...
    async def delete(self,request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[WithRuleDeleteResponse]:
        """
        Alias von DELETE /api/v1/tanssEvents/rules/{ruleId} - loescht eine Event-Regel. Nicht in der offiziellen Schnittstellenbeschreibung gefuehrt; vom Server so umgesetzt, gegen 10.10 geprueft. Token: module, Rollen TANSS_APP. Rechte: interner Benutzertyp; bet.ADMINISTRATE_TANSS_EVENT_RULES. Hinweise: Status DELETED. Auch unter /api/tanss.x/v1.
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[WithRuleGetResponse]:
        """
        Alias von GET /api/v1/tanssEvents/rules/{ruleId} - liefert eine Event-Regel. Nicht in der offiziellen Schnittstellenbeschreibung gefuehrt; vom Server so umgesetzt, gegen 10.10 geprueft. Token: module, Rollen TANSS_APP. Rechte: interner Benutzertyp; bet.ADMINISTRATE_TANSS_EVENT_RULES. Hinweise: 404 OBJECT_NOT_FOUND. Auch unter /api/tanss.x/v1.
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    async def put(self,body: WithRulePutRequestBody, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[WithRulePutResponse]:
        """
        Alias von PUT /api/v1/tanssEvents/rules/{ruleId} - aktualisiert eine Event-Regel per JSON-Merge. Nicht in der offiziellen Schnittstellenbeschreibung gefuehrt; vom Server so umgesetzt, gegen 10.10 geprueft. Token: module, Rollen TANSS_APP. Rechte: interner Benutzertyp; bet.ADMINISTRATE_TANSS_EVENT_RULES. Hinweise: Key "id" im Body wird ignoriert. Status UPDATED. Auch unter /api/tanss.x/v1.
