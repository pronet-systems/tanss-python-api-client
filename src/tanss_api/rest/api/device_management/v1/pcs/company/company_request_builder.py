...
class CompanyRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/api/deviceManagement/v1/pcs/company", path_parameters)
    
    def by_company_id(self,company_id: int) -> WithCompanyItemRequestBuilder:
        """
        Gets an item from the tanss_api.rest.api.deviceManagement.v1.pcs.company.item collection
