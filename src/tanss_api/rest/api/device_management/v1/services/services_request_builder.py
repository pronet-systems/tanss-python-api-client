...
class ServicesRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/api/deviceManagement/v1/services", path_parameters)
    
    def by_id(self,id: int) -> ServicesItemRequestBuilder:
        """
        Gets an item from the tanss_api.rest.api.deviceManagement.v1.services.item collection
        param id: Id des Dienstes.
