...
if TYPE_CHECKING:
    ...
    from .tickets_get_response_content import TicketsGetResponse_content

@dataclass
class TicketsGetResponse(AdditionalDataHolder, Parsable):
    # Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.
    additional_data: dict[str, Any] = field(default_factory=dict)

    # Sub-tickets of the project.
    content: Optional[list[TicketsGetResponse_content]] = None
    # The meta property
    ...
    def get_field_deserializers(self,) -> dict[str, Callable[[ParseNode], None]]:
        ...
        fields: dict[str, Callable[[Any], None]] = {
            "content": lambda n : setattr(self, 'content', n.get_collection_of_object_values(TicketsGetResponse_content)),
