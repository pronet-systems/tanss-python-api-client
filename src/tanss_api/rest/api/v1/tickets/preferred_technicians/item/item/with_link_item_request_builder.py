...
class WithLinkItemRequestBuilder(BaseRequestBuilder):
    """
    Builds and executes requests for operations under /api/v1/tickets/preferredTechnicians/{linkTypeId}/{linkId}
    """
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/api/v1/tickets/preferredTechnicians/{linkTypeId}/{linkId}", path_parameters)
    
    async def get(self,request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[WithLinkGetResponse]:
        """
        Returns the technicians flagged as preferred for the given assignment`(linkTypeId, linkId)` — these are the technicians the customer or device ownerwants to receive their tickets, grouped by relationship type. The caller musthave access to the assignment.
