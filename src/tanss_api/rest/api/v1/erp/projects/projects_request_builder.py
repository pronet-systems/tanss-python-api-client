...
class ProjectsRequestBuilder(BaseRequestBuilder):
    """
    Builds and executes requests for operations under /api/v1/erp/projects
    """
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/api/v1/erp/projects", path_parameters)
    
    async def get(self,request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[ProjectsGetResponse]:
        """
        Returns the list of projects from the configured ERP backend via the factory-resolved ERP service. This is a user-facing route inside TANSS — it is called with a normal user login token, not with the token-bound `/api/erp/v1/...` integration routes. If no ERP service is configured, an empty list is returned.
