...
if TYPE_CHECKING:
    from .....models.timestamp_state import TimestampState
    from .....models.timestamp_type import TimestampType

@dataclass
class TimestampPostRequestBody(AdditionalDataHolder, Parsable):
    # Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.
    additional_data: dict[str, Any] = field(default_factory=dict)

    # Unix-Sekunden; 0 = jetzt
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> TimestampPostRequestBody:
        """
        Creates a new instance of the appropriate class based on discriminator value
        param parse_node: The parse node to use to read the discriminator value and create the object
        Returns: TimestampPostRequestBody
        """
        if parse_node is None:
            raise TypeError("parse_node cannot be null.")
        return TimestampPostRequestBody()
