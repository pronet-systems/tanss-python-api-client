...
class ConditionsRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/api/v1/supportRules/frontend/conditions", path_parameters)
    
    def by_type(self,type: str) -> WithTypeItemRequestBuilder:
        """
        Gets an item from the tanss_api.rest.api.v1.supportRules.frontend.conditions.item collection
        param type: Support-rule condition type whose UI field definition is requested.
