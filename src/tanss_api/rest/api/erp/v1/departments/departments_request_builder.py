...
class DepartmentsRequestBuilder(BaseRequestBuilder):
    """
    Builds and executes requests for operations under /api/erp/v1/departments
    """
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/api/erp/v1/departments", path_parameters)
    
    def by_department_id(self,department_id: int) -> WithDepartmentItemRequestBuilder:
        """
        Gets an item from the tanss_api.rest.api.erp.v1.departments.item collection
