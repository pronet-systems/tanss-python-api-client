...
class WithDayItemRequestBuilder(BaseRequestBuilder):
    """
    Builds and executes requests for operations under /api/v1/timestamps/{employee-id}/day/{day}
    """
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/api/v1/timestamps/{employee%2Did}/day/{day}", path_parameters)
    
    async def put(self,body: list[Timestamp], request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[WithDayPutResponse]:
        """
    ...
    def to_put_request_information(self,body: list[Timestamp], request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> RequestInformation:
        """
        This call automatically saves all timestamps of a single day into the databse (automatically determines which of those shall be inserted, updated or deleted)
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
