...
@dataclass
class WithTimerPostResponse(AdditionalDataHolder, Parsable):
    ...
    content: Optional[TimerFragment] = None
    # The meta property
    meta: Optional[TnsMetaMessage] = None
    
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> WithTimerPostResponse:
        """
        Creates a new instance of the appropriate class based on discriminator value
        param parse_node: The parse node to use to read the discriminator value and create the object
        Returns: WithTimerPostResponse
        """
        if parse_node is None:
            raise TypeError("parse_node cannot be null.")
        return WithTimerPostResponse()
    ...
    def get_field_deserializers(self,) -> dict[str, Callable[[ParseNode], None]]:
        ...
        fields: dict[str, Callable[[Any], None]] = {
            "content": lambda n : setattr(self, 'content', n.get_object_value(TimerFragment)),
