...
class WithLinkItemRequestBuilder(BaseRequestBuilder):
    """
    Builds and executes requests for operations under /api/v1/tickets/unwantedTechnicians/{linkTypeId}/{linkId}
    """
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/api/v1/tickets/unwantedTechnicians/{linkTypeId}/{linkId}", path_parameters)
    
    async def get(self,request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[WithLinkGetResponse]:
        """
        Returns the technicians explicitly excluded for the given assignment`(linkTypeId, linkId)` — the inverse of `/preferredTechnicians`. Used to warnwhen assigning an unwanted technician to a ticket on this asset. The callermust have access to the assignment.
