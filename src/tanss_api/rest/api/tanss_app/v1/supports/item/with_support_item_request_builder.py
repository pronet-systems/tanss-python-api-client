...
if TYPE_CHECKING:
    ...
    from .with_support_put_request_body import WithSupportPutRequestBody
    from .with_support_put_response import WithSupportPutResponse

class WithSupportItemRequestBuilder(BaseRequestBuilder):
    """
    Builds and executes requests for operations under /api/tanss.app/v1/supports/{supportId}
    """
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/api/tanss.app/v1/supports/{supportId}{?discardOnSupport*,isOrganizer*}", path_parameters)
    ...
    async def put(self,body: WithSupportPutRequestBody, request_configuration: Optional[RequestConfiguration[WithSupportItemRequestBuilderPutQueryParameters]] = None) -> Optional[WithSupportPutResponse]:
        """
        Aktualisiert eine Taetigkeit per JSON-Merge (wie PUT /api/v1/supports/{id}); setzt im JSON automatisch automaticallyResolveConflicts=true, bei isOrganizer=true zusaetzlich preventNotification=true, bei discardOnSupport=true zusaetzlich discardOnSupport=true. Nicht in der offiziellen Schnittstellenbeschreibung gefuehrt; vom Server so umgesetzt, gegen 10.10 geprueft. Token: module, Rollen TANSS_APP. Hinweise: Key "id" im Body wird ignoriert. Status UPDATED. Rechte nicht vollstaendig analysiert. Auch unter /api/tanss.x/v1.
    ...
    def to_put_request_information(self,body: WithSupportPutRequestBody, request_configuration: Optional[RequestConfiguration[WithSupportItemRequestBuilderPutQueryParameters]] = None) -> RequestInformation:
        """
        Aktualisiert eine Taetigkeit per JSON-Merge (wie PUT /api/v1/supports/{id}); setzt im JSON automatisch automaticallyResolveConflicts=true, bei isOrganizer=true zusaetzlich preventNotification=true, bei discardOnSupport=true zusaetzlich discardOnSupport=true. Nicht in der offiziellen Schnittstellenbeschreibung gefuehrt; vom Server so umgesetzt, gegen 10.10 geprueft. Token: module, Rollen TANSS_APP. Hinweise: Key "id" im Body wird ignoriert. Status UPDATED. Rechte nicht vollstaendig analysiert. Auch unter /api/tanss.x/v1.
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    class WithSupportItemRequestBuilderDeleteQueryParameters():
        ...
        # Bei umgewandelten Terminen nicht loeschen (403 CHANGES_WERE_DISCARDED)
    ...
    class WithSupportItemRequestBuilderPutQueryParameters():
        ...
        # true setzt discardOnSupport=true
        discard_on_support: Optional[bool] = None

        # true setzt preventNotification=true
