...
class WithLinkItemRequestBuilder(BaseRequestBuilder):
    """
    Builds and executes requests for operations under /api/v1/assignments/flags/{linkTypeId}/{linkId}
    """
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/api/v1/assignments/flags/{linkTypeId}/{linkId}", path_parameters)
    
    async def get(self,request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[WithLinkGetResponse]:
        """
        Returns the list of "flag icons" (small status badges like "VIP customer", "maintenance contract active", "device in service")that should be shown next to an assignment in the ticket header. The assignment is addressed by its `linkTypeId` + `linkId`;access to the underlying company is required.
