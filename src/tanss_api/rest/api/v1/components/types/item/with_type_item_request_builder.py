...
if TYPE_CHECKING:
    from ......models.tns_component_type import TnsComponentType
...
class WithTypeItemRequestBuilder(BaseRequestBuilder):
    """
    Builds and executes requests for operations under /api/v1/components/types/{typeId}
    """
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/api/v1/components/types/{typeId}", path_parameters)
    ...
    async def put(self,body: TnsComponentType, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[WithTypePutResponse]:
        """
        Updates a component type
        param body: Component type
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
        ...
        return await self.request_adapter.send_async(request_info, WithTypePutResponse, error_mapping)
    ...
    def to_put_request_information(self,body: TnsComponentType, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> RequestInformation:
        """
        Updates a component type
        param body: Component type
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
