...
class WithEmployeeItemRequestBuilder(BaseRequestBuilder):
    """
    Builds and executes requests for operations under /api/v1/permissions/setAllFor/{employeeId}
    """
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/api/v1/permissions/setAllFor/{employeeId}", path_parameters)
    ...
    async def put(self,request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[WithEmployeePutResponse]:
        """
        Adds every permission that the employee's type is allowed to receiveto the given employee. Caller must be from the own company and hold`MANAGE_PERMISSIONS` + `EMPLOYEE_ADMINISTRATION`.
