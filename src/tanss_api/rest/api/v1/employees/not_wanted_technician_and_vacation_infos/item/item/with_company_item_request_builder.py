...
class WithCompanyItemRequestBuilder(BaseRequestBuilder):
    """
    Builds and executes requests for operations under /api/v1/employees/notWantedTechnicianAndVacationInfos/{employeeId}/{companyId}
    """
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/api/v1/employees/notWantedTechnicianAndVacationInfos/{employeeId}/{companyId}", path_parameters)
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[WithCompanyGetResponse]:
        """
        Returns, for a given employee/company pair, both the flag whether thecustomer has marked this technician as "not wanted" and the technician'scurrent vacation status. Caller must be a technician or freelancer withaccess to `companyId`.
