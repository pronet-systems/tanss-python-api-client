...
class ImportRequestBuilder(BaseRequestBuilder):
    """
    Builds and executes requests for operations under /api/v1/templates/import
    """
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/api/v1/templates/import", path_parameters)
    
    def by_template_type(self,template_type: str) -> WithTemplateTypeItemRequestBuilder:
        """
        Gets an item from the tanss_api.rest.api.v1.templates.import.item collection
        param template_type: Type of the template being imported (e.g. TICKET).
