...
class CompaniesRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/api/systemhaus_one/v1/companies", path_parameters)
    
    def by_id(self,id: int) -> CompaniesItemRequestBuilder:
        """
        Gets an item from the tanss_api.rest.api.systemhaus_one.v1.companies.item collection
    ...
    async def post(self,body: CompanyPost, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[CompaniesPostResponse]:
        ...
        return await self.request_adapter.send_async(request_info, CompaniesPostResponse, None)
