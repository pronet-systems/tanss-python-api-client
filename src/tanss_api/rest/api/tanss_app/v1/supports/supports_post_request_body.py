...
@dataclass
class SupportsPostRequestBody(TnsSupport, Parsable):
    # Umwandlung eines Serientermins - Id des Master-Termins
    recurrence_master_link_id: Optional[int] = None
    # The recurrenceRuleSequenceId property
    recurrence_rule_sequence_id: Optional[int] = None
    # The recurrenceRuleSequenceTimestamp property
