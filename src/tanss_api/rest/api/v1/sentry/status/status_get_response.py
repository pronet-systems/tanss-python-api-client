...
if TYPE_CHECKING:
    ...
    from .....models.tns_sentry_status_response import TnsSentryStatusResponse
...
class StatusGetResponse(AdditionalDataHolder, Parsable):
    ...
    content: Optional[TnsSentryStatusResponse] = None
    # The meta property
    ...
    def get_field_deserializers(self,) -> dict[str, Callable[[ParseNode], None]]:
        ...
        fields: dict[str, Callable[[Any], None]] = {
            "content": lambda n : setattr(self, 'content', n.get_object_value(TnsSentryStatusResponse)),
