...
class TypesRequestBuilder(BaseRequestBuilder):
    """
    Builds and executes requests for operations under /api/erp/v1/types
    """
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/api/erp/v1/types", path_parameters)
    
    def by_type_id(self,type_id: int) -> WithTypeItemRequestBuilder:
        """
        Gets an item from the tanss_api.rest.api.erp.v1.types.item collection
        param type_id: ID of the company type.
