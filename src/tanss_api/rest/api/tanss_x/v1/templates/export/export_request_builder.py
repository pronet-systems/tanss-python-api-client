...
class ExportRequestBuilder(BaseRequestBuilder):
    """
    Builds and executes requests for operations under /api/tanss.x/v1/templates/export
    """
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/api/tanss.x/v1/templates/export", path_parameters)
    
    def by_template_type(self,template_type: str) -> WithTemplateTypeItemRequestBuilder:
        """
        Gets an item from the tanss_api.rest.api.tanssX.v1.templates.export.item collection
        param template_type: Unique identifier of the item
