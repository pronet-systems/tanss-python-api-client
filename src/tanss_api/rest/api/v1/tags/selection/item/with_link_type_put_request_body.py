...
class WithLinkTypePutRequestBody(AdditionalDataHolder, Parsable):
    """
    Implementation-specific selection object. Typically contains anarray of ids (`ticketIds`, `deviceIds`, …) and optional filterflags — verify the exact shape against the schema.
    """
