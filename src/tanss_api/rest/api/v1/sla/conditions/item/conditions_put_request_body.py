...
if TYPE_CHECKING:
    from .conditions_put_request_body_priorities import ConditionsPutRequestBody_priorities
    from .conditions_put_request_body_ticket_types import ConditionsPutRequestBody_ticketTypes

@dataclass
class ConditionsPutRequestBody(AdditionalDataHolder, Parsable):
    """
    Request body.
    """
    ...
    priorities: Optional[list[ConditionsPutRequestBody_priorities]] = None
    ...
    ticket_types: Optional[list[ConditionsPutRequestBody_ticketTypes]] = None
    # Identifier of the working time model used to calculate deadlines
    working_time_model: Optional[int] = None
    
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> ConditionsPutRequestBody:
        """
        Creates a new instance of the appropriate class based on discriminator value
        param parse_node: The parse node to use to read the discriminator value and create the object
        Returns: ConditionsPutRequestBody
        """
        if parse_node is None:
            raise TypeError("parse_node cannot be null.")
        return ConditionsPutRequestBody()
    ...
    def get_field_deserializers(self,) -> dict[str, Callable[[ParseNode], None]]:
        ...
        fields: dict[str, Callable[[Any], None]] = {
            ...
            "priorities": lambda n : setattr(self, 'priorities', n.get_collection_of_object_values(ConditionsPutRequestBody_priorities)),
            ...
            "ticketTypes": lambda n : setattr(self, 'ticket_types', n.get_collection_of_object_values(ConditionsPutRequestBody_ticketTypes)),
    ...
    def serialize(self,writer: SerializationWriter) -> None:
        ...
        writer.write_int_value("slaId", self.sla_id)
