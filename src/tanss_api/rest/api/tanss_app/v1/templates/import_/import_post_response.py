...
if TYPE_CHECKING:
    ...
    from ......models.tns_pending_import import TnsPendingImport
...
class ImportPostResponse(AdditionalDataHolder, Parsable):
    ...
    content: Optional[TnsPendingImport] = None
    # The meta property
    ...
    def get_field_deserializers(self,) -> dict[str, Callable[[ParseNode], None]]:
        ...
        fields: dict[str, Callable[[Any], None]] = {
            "content": lambda n : setattr(self, 'content', n.get_object_value(TnsPendingImport)),
