...
class DocumentsRequestBuilder(BaseRequestBuilder):
    """
    Builds and executes requests for operations under /api/v1/tickets/{-id}/documents
    """
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/api/v1/tickets/{%2Did}/documents", path_parameters)
    
    def by_document_id(self,document_id: int) -> WithDocumentItemRequestBuilder:
        """
        Gets an item from the tanss_api.rest.api.v1.tickets.item.documents.item collection
    ...
    @dataclass
    class DocumentsRequestBuilderGetRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
