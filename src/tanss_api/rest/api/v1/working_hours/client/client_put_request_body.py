...
if TYPE_CHECKING:
    from .client_put_request_body_days import ClientPutRequestBody_days

@dataclass
class ClientPutRequestBody(AdditionalDataHolder, Parsable):
    # Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.
    additional_data: dict[str, Any] = field(default_factory=dict)

    # Working hours per weekday, keyed by day of the week
    days: Optional[ClientPutRequestBody_days] = None
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> ClientPutRequestBody:
        """
        Creates a new instance of the appropriate class based on discriminator value
        param parse_node: The parse node to use to read the discriminator value and create the object
        Returns: ClientPutRequestBody
        """
    ...
    def get_field_deserializers(self,) -> dict[str, Callable[[ParseNode], None]]:
        ...
        fields: dict[str, Callable[[Any], None]] = {
            "days": lambda n : setattr(self, 'days', n.get_object_value(ClientPutRequestBody_days)),
