...
class OsRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/api/deviceManagement/v1/os", path_parameters)
    
    def by_id(self,id: int) -> OsItemRequestBuilder:
        """
        Gets an item from the tanss_api.rest.api.deviceManagement.v1.os.item collection
        param id: ID des Betriebssystems
