...
class ImportRequestBuilder(BaseRequestBuilder):
    """
    Builds and executes requests for operations under /api/tanss.x/v1/templates/import
    """
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/api/tanss.x/v1/templates/import", path_parameters)
    ...
    async def post(self,body: ImportPostRequestBody, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[ImportPostResponse]:
        """
        Legt einen ausstehenden Vorlagen-Import (TnsPendingImport) aus einem anderen TANSS-System an. Nicht in der offiziellen Schnittstellenbeschreibung gefuehrt; vom Server so umgesetzt, gegen 10.10 geprueft. Token: module, Rollen TANSS_APP. Rechte: SecurityManager.long(), EDIT_ALL_PROCESSES. Hinweise: Auch unter /api/tanss.app/v1. date=now, importDate=0, importEmployeeId=0 (noch nicht importiert). meta.status CREATED.
        param body: TnsPendingImport-Felder; date, importDate und importEmployeeId werden serverseitig gesetzt.
        ...
        return await self.request_adapter.send_async(request_info, ImportPostResponse, None)
