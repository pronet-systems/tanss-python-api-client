...
if TYPE_CHECKING:
    from .passwords_post_request_body_link_type import PasswordsPostRequestBody_linkType

@dataclass
class PasswordsPostRequestBody(AdditionalDataHolder, Parsable):
    """
    Request body.
    """
    ...
    link_type: Optional[PasswordsPostRequestBody_linkType] = None
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> PasswordsPostRequestBody:
        """
        Creates a new instance of the appropriate class based on discriminator value
        param parse_node: The parse node to use to read the discriminator value and create the object
        Returns: PasswordsPostRequestBody
        """
        if parse_node is None:
            raise TypeError("parse_node cannot be null.")
        return PasswordsPostRequestBody()
    ...
    def get_field_deserializers(self,) -> dict[str, Callable[[ParseNode], None]]:
        ...
        fields: dict[str, Callable[[Any], None]] = {
            ...
            "linkType": lambda n : setattr(self, 'link_type', n.get_enum_value(PasswordsPostRequestBody_linkType)),
