...
class TypesRequestBuilder(BaseRequestBuilder):
    """
    Builds and executes requests for operations under /api/v1/components/types
    """
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/api/v1/components/types", path_parameters)
    
    def by_type_id(self,type_id: int) -> WithTypeItemRequestBuilder:
        """
        Gets an item from the tanss_api.rest.api.v1.components.types.item collection
    ...
    async def post(self,body: TnsComponentType, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[TypesPostResponse]:
        """
    ...
    def to_post_request_information(self,body: TnsComponentType, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> RequestInformation:
        """
        Creates a new component type
        param body: Component type
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
