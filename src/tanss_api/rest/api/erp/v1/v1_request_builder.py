...
if TYPE_CHECKING:
    from .accountingtypes.accountingtypes_request_builder import AccountingtypesRequestBuilder
...
class V1RequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/api/erp/v1", path_parameters)
    
    @property
    def accountingtypes(self) -> AccountingtypesRequestBuilder:
        """
