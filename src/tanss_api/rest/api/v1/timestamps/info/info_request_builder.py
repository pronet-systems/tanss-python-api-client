...
if TYPE_CHECKING:
    from .....models.info403_error import Info403Error
    from .info_get_response import InfoGetResponse

class InfoRequestBuilder(BaseRequestBuilder):
    """
    Builds and executes requests for operations under /api/v1/timestamps/info
    """
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/api/v1/timestamps/info{?from*,till*}", path_parameters)
    
    async def get(self,request_configuration: Optional[RequestConfiguration[InfoRequestBuilderGetQueryParameters]] = None) -> Optional[InfoGetResponse]:
        """
        gets the timestamp infos for a given time period
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
        Returns: Optional[InfoGetResponse]
        """
        ...
        return await self.request_adapter.send_async(request_info, InfoGetResponse, error_mapping)
