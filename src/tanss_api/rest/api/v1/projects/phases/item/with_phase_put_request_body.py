...
if TYPE_CHECKING:
    from .with_phase_put_request_body_billing_type import WithPhasePutRequestBody_billingType
    from .with_phase_put_request_body_clearance_mode import WithPhasePutRequestBody_clearanceMode

@dataclass
class WithPhasePutRequestBody(AdditionalDataHolder, Parsable):
    """
    Request body.
    """
    ...
    billing_type: Optional[WithPhasePutRequestBody_billingType] = None
    # Clearance mode controlling whether tickets in the phase may be cleared.
    clearance_mode: Optional[WithPhasePutRequestBody_clearanceMode] = None
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> WithPhasePutRequestBody:
        """
        Creates a new instance of the appropriate class based on discriminator value
        param parse_node: The parse node to use to read the discriminator value and create the object
        Returns: WithPhasePutRequestBody
        """
        if parse_node is None:
            raise TypeError("parse_node cannot be null.")
        return WithPhasePutRequestBody()
    ...
    def get_field_deserializers(self,) -> dict[str, Callable[[ParseNode], None]]:
        ...
        fields: dict[str, Callable[[Any], None]] = {
            "billingType": lambda n : setattr(self, 'billing_type', n.get_enum_value(WithPhasePutRequestBody_billingType)),
            "clearanceMode": lambda n : setattr(self, 'clearance_mode', n.get_enum_value(WithPhasePutRequestBody_clearanceMode)),
