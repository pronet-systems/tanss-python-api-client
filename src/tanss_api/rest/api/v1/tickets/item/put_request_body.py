...
if TYPE_CHECKING:
    from .....models.tns_tag_assign import TnsTagAssign
    from .....models.tns_ticket_clearance_mode import TnsTicketClearanceMode
    from .....models.tns_ticket_resubmission_mail_options import TnsTicketResubmissionMailOptions
    from .....models.tns_ticket_resubmission_mode import TnsTicketResubmissionMode
    from .put_request_body_attention import PutRequestBody_attention
    from .put_request_body_installation_fee import PutRequestBody_installationFee
    from .put_request_body_installation_fee_drive_mode import PutRequestBody_installationFeeDriveMode
    from .put_request_body_local_ticket_admin_flag import PutRequestBody_localTicketAdminFlag
...
class PutRequestBody(AdditionalDataHolder, Parsable):
    ...
    attention: Optional[PutRequestBody_attention] = None
    ...
    installation_fee: Optional[PutRequestBody_installationFee] = None
    ...
    installation_fee_drive_mode: Optional[PutRequestBody_installationFeeDriveMode] = None
    ...
    local_ticket_admin_flag: Optional[PutRequestBody_localTicketAdminFlag] = None
    ...
    def get_field_deserializers(self,) -> dict[str, Callable[[ParseNode], None]]:
        ...
        fields: dict[str, Callable[[Any], None]] = {
            ...
            "attention": lambda n : setattr(self, 'attention', n.get_enum_value(PutRequestBody_attention)),
            ...
            "installationFee": lambda n : setattr(self, 'installation_fee', n.get_enum_value(PutRequestBody_installationFee)),
            "installationFeeAmount": lambda n : setattr(self, 'installation_fee_amount', n.get_float_value()),
            "installationFeeDriveMode": lambda n : setattr(self, 'installation_fee_drive_mode', n.get_enum_value(PutRequestBody_installationFeeDriveMode)),
            ...
            "localTicketAdminFlag": lambda n : setattr(self, 'local_ticket_admin_flag', n.get_enum_value(PutRequestBody_localTicketAdminFlag)),
