...
if TYPE_CHECKING:
    from .....models.history403_error import History403Error
    from .history_get_response import HistoryGetResponse

class HistoryRequestBuilder(BaseRequestBuilder):
    """
    Builds and executes requests for operations under /api/v1/overtime/history
    """
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/api/v1/overtime/history", path_parameters)
    
    async def get(self,request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[HistoryGetResponse]:
        """
