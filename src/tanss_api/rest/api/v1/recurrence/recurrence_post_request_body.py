...
if TYPE_CHECKING:
    from .recurrence_post_request_body_employee_ids import RecurrencePostRequestBody_employeeIds
...
class RecurrencePostRequestBody(AdditionalDataHolder, Parsable):
    ...
    employee_ids: Optional[list[RecurrencePostRequestBody_employeeIds]] = None
    ...
    def get_field_deserializers(self,) -> dict[str, Callable[[ParseNode], None]]:
        ...
        fields: dict[str, Callable[[Any], None]] = {
            "employeeIds": lambda n : setattr(self, 'employee_ids', n.get_collection_of_object_values(RecurrencePostRequestBody_employeeIds)),
