...
class PropertiesRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/api/v1/genericAssignments/properties", path_parameters)
    
    def by_source_type(self,source_type: str) -> WithSourceTypeItemRequestBuilder:
        """
        Gets an item from the tanss_api.rest.api.v1.genericAssignments.properties.item collection
