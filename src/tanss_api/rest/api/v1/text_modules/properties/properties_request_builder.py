...
class PropertiesRequestBuilder(BaseRequestBuilder):
    """
    Builds and executes requests for operations under /api/v1/textModules/properties
    """
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/api/v1/textModules/properties", path_parameters)
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[PropertiesGetResponse]:
        """
        Returns the list-properties payload (columns, filters, default sort, ...) used by the client to render thetext-module overview. Visibility-restricted columns are omitted based on the caller's permissions.
