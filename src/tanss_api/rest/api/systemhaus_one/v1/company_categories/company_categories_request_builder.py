...
class CompanyCategoriesRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/api/systemhaus_one/v1/companyCategories", path_parameters)
    
    def by_category_id(self,category_id: int) -> WithCategoryItemRequestBuilder:
        """
        Gets an item from the tanss_api.rest.api.systemhaus_one.v1.companyCategories.item collection
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[CompanyCategoriesGetResponse]:
        """
        Liefert alle Firmentyp-Kategorien inkl. zugehöriger Firmentypen, vorangestellt eine virtuelle Standardkategorie.Nicht in der offiziellen Schnittstellenbeschreibung gefuehrt; vom Server so umgesetzt, gegen 10.10 geprueft.Token: module, Rollen SYSTEMHAUS_ONE.Hinweise: Lizenz SAP_ONE erforderlich. Erster Eintrag ist die Default-Kategorie mit id=0 (sprachabhängiger Name) für Typen ohne Kategorie. Keine Rechteprüfung.
        ...
        return await self.request_adapter.send_async(request_info, CompanyCategoriesGetResponse, None)
