...
if TYPE_CHECKING:
    from .ticket_standard_attention import TicketStandard_attention
    from .ticket_standard_installation_fee import TicketStandard_installationFee
    from .ticket_standard_installation_fee_drive_mode import TicketStandard_installationFeeDriveMode
    from .ticket_standard_local_ticket_admin_flag import TicketStandard_localTicketAdminFlag
...
@dataclass
class TicketStandard(AdditionalDataHolder, Parsable):
    ...
    attention: Optional[TicketStandard_attention] = None
    ...
    installation_fee: Optional[TicketStandard_installationFee] = None
    ...
    installation_fee_drive_mode: Optional[TicketStandard_installationFeeDriveMode] = None
    ...
    local_ticket_admin_flag: Optional[TicketStandard_localTicketAdminFlag] = None
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> TicketStandard:
        """
        Creates a new instance of the appropriate class based on discriminator value
        param parse_node: The parse node to use to read the discriminator value and create the object
        Returns: TicketStandard
        """
    ...
    def get_field_deserializers(self,) -> dict[str, Callable[[ParseNode], None]]:
        ...
        fields: dict[str, Callable[[Any], None]] = {
            ...
            "attention": lambda n : setattr(self, 'attention', n.get_enum_value(TicketStandard_attention)),
            ...
            "installationFee": lambda n : setattr(self, 'installation_fee', n.get_enum_value(TicketStandard_installationFee)),
            "installationFeeAmount": lambda n : setattr(self, 'installation_fee_amount', n.get_float_value()),
            "installationFeeDriveMode": lambda n : setattr(self, 'installation_fee_drive_mode', n.get_enum_value(TicketStandard_installationFeeDriveMode)),
            ...
            "localTicketAdminFlag": lambda n : setattr(self, 'local_ticket_admin_flag', n.get_enum_value(TicketStandard_localTicketAdminFlag)),
