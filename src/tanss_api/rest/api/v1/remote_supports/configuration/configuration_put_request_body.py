...
if TYPE_CHECKING:
    from .configuration_put_request_body_type import ConfigurationPutRequestBody_type

@dataclass
class ConfigurationPutRequestBody(AdditionalDataHolder, Parsable):
    ...
    type: Optional[ConfigurationPutRequestBody_type] = None
    # Username for authenticating against the remote maintenance service.
    username: Optional[str] = None
    
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> ConfigurationPutRequestBody:
        """
        Creates a new instance of the appropriate class based on discriminator value
        param parse_node: The parse node to use to read the discriminator value and create the object
        Returns: ConfigurationPutRequestBody
        """
        if parse_node is None:
            raise TypeError("parse_node cannot be null.")
        return ConfigurationPutRequestBody()
    ...
    def get_field_deserializers(self,) -> dict[str, Callable[[ParseNode], None]]:
        ...
        fields: dict[str, Callable[[Any], None]] = {
            ...
            "type": lambda n : setattr(self, 'type', n.get_enum_value(ConfigurationPutRequestBody_type)),
