...
if TYPE_CHECKING:
    from .with_day_put_request_body_type import WithDayPutRequestBody_type

@dataclass
class WithDayPutRequestBody(AdditionalDataHolder, Parsable):
    ...
    type: Optional[WithDayPutRequestBody_type] = None
    # Year of the holiday, or 0 for a recurring fixed holiday.
    year: Optional[int] = None
    
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> WithDayPutRequestBody:
        """
        Creates a new instance of the appropriate class based on discriminator value
        param parse_node: The parse node to use to read the discriminator value and create the object
        Returns: WithDayPutRequestBody
        """
        if parse_node is None:
            raise TypeError("parse_node cannot be null.")
        return WithDayPutRequestBody()
    ...
    def get_field_deserializers(self,) -> dict[str, Callable[[ParseNode], None]]:
        ...
        fields: dict[str, Callable[[Any], None]] = {
            ...
            "type": lambda n : setattr(self, 'type', n.get_enum_value(WithDayPutRequestBody_type)),
