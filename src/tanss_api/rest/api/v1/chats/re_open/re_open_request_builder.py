...
class ReOpenRequestBuilder(BaseRequestBuilder):
    """
    Builds and executes requests for operations under /api/v1/chats/reOpen
    """
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/api/v1/chats/reOpen", path_parameters)
    
    def by_chat_id(self,chat_id: int) -> WithChatItemRequestBuilder:
        """
        Gets an item from the tanss_api.rest.api.v1.chats.reOpen.item collection
