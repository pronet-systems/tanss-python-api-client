...
class MailRequestBuilder(BaseRequestBuilder):
    """
    Builds and executes requests for operations under /api/tanss.x/v1/ticket/{ticketId}/mail
    """
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/api/tanss.x/v1/ticket/{ticketId}/mail", path_parameters)
    ...
    async def post(self,body: str, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[MailPostResponse]:
        ...
        return await self.request_adapter.send_async(request_info, MailPostResponse, None)
