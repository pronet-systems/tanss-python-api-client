...
class PdfRequestBuilder(BaseRequestBuilder):
    """
    Builds and executes requests for operations under /api/v1/offers/pdf
    """
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/api/v1/offers/pdf", path_parameters)
    
    def by_offer_id(self,offer_id: int) -> WithOfferItemRequestBuilder:
        """
        Gets an item from the tanss_api.rest.api.v1.offers.pdf.item collection
