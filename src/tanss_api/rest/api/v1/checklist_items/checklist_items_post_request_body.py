...
if TYPE_CHECKING:
    from .checklist_items_post_request_body_type import ChecklistItemsPostRequestBody_type

@dataclass
class ChecklistItemsPostRequestBody(AdditionalDataHolder, Parsable):
    ...
    type: Optional[ChecklistItemsPostRequestBody_type] = None
    
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> ChecklistItemsPostRequestBody:
        """
        Creates a new instance of the appropriate class based on discriminator value
        param parse_node: The parse node to use to read the discriminator value and create the object
        Returns: ChecklistItemsPostRequestBody
        """
        if parse_node is None:
            raise TypeError("parse_node cannot be null.")
        return ChecklistItemsPostRequestBody()
    ...
    def get_field_deserializers(self,) -> dict[str, Callable[[ParseNode], None]]:
        ...
        fields: dict[str, Callable[[Any], None]] = {
            ...
            "type": lambda n : setattr(self, 'type', n.get_enum_value(ChecklistItemsPostRequestBody_type)),
        }
        return fields
