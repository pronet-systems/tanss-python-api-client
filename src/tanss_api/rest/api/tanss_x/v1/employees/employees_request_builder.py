...
class EmployeesRequestBuilder(BaseRequestBuilder):
    """
    Builds and executes requests for operations under /api/tanss.x/v1/employees
    """
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/api/tanss.x/v1/employees", path_parameters)
    
    def by_employee_id(self,employee_id: int) -> WithEmployeeItemRequestBuilder:
        """
        Gets an item from the tanss_api.rest.api.tanssX.v1.employees.item collection
