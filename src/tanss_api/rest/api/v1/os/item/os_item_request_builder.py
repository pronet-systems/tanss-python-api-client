...
class OsItemRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/api/v1/os/{id}", path_parameters)
    ...
    async def put(self,body: TnsPersonalComputerOperatingSystem, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[OsPutResponse]:
        """
        ...
        return await self.request_adapter.send_async(request_info, OsPutResponse, error_mapping)
    ...
    def to_put_request_information(self,body: TnsPersonalComputerOperatingSystem, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> RequestInformation:
        """
        Updates an existing operating system
        param body: representing a operating system to be used for pc/servers
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
