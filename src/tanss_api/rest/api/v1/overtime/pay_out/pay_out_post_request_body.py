...
if TYPE_CHECKING:
    from .pay_out_post_request_body_status import PayOutPostRequestBody_status

@dataclass
class PayOutPostRequestBody(AdditionalDataHolder, Parsable):
    """
    Request body.
    """
    ...
    status: Optional[PayOutPostRequestBody_status] = None
    
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> PayOutPostRequestBody:
        """
        Creates a new instance of the appropriate class based on discriminator value
        param parse_node: The parse node to use to read the discriminator value and create the object
        Returns: PayOutPostRequestBody
        """
        if parse_node is None:
            raise TypeError("parse_node cannot be null.")
        return PayOutPostRequestBody()
    ...
    def get_field_deserializers(self,) -> dict[str, Callable[[ParseNode], None]]:
        ...
        fields: dict[str, Callable[[Any], None]] = {
            ...
            "status": lambda n : setattr(self, 'status', n.get_enum_value(PayOutPostRequestBody_status)),
        }
        return fields
