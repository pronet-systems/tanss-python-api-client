...
class StatusRequestBuilder(BaseRequestBuilder):
    """
    Builds and executes requests for operations under /api/v1/passkey/status
    """
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/api/v1/passkey/status", path_parameters)
    
    async def get(self,request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[StatusGetResponse]:
        """
        Returns whether WebAuthn / passkey login is enabled on the server. Used bythe login page to decide whether to show the passkey button.
