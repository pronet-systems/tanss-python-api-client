...
class TypesRequestBuilder(BaseRequestBuilder):
    """
    Builds and executes requests for operations under /api/v1/companyCategories/types
    """
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/api/v1/companyCategories/types", path_parameters)
    
    def by_id(self,id: int) -> TypesItemRequestBuilder:
        """
        Gets an item from the tanss_api.rest.api.v1.companyCategories.types.item collection
        param id: Id of the company type
