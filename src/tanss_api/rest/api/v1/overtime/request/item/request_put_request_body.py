...
if TYPE_CHECKING:
    from .request_put_request_body_status import RequestPutRequestBody_status

@dataclass
class RequestPutRequestBody(AdditionalDataHolder, Parsable):
    """
    Request body.
    """
    ...
    status: Optional[RequestPutRequestBody_status] = None
    
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> RequestPutRequestBody:
        """
        Creates a new instance of the appropriate class based on discriminator value
        param parse_node: The parse node to use to read the discriminator value and create the object
        Returns: RequestPutRequestBody
        """
        if parse_node is None:
            raise TypeError("parse_node cannot be null.")
        return RequestPutRequestBody()
    ...
    def get_field_deserializers(self,) -> dict[str, Callable[[ParseNode], None]]:
        ...
        fields: dict[str, Callable[[Any], None]] = {
            ...
            "status": lambda n : setattr(self, 'status', n.get_enum_value(RequestPutRequestBody_status)),
        }
        return fields
