...
class EventsRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/api/v1/escalations/frontend/events", path_parameters)
    
    def by_event_type(self,event_type: str) -> WithEventTypeItemRequestBuilder:
        """
        Gets an item from the tanss_api.rest.api.v1.escalations.frontend.events.item collection
        param event_type: Escalation rule event type whose frontend form definition is requested.
