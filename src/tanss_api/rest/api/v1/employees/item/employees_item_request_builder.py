...
if TYPE_CHECKING:
    ...
    from .reachability.reachability_request_builder import ReachabilityRequestBuilder
...
class EmployeesItemRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/api/v1/employees/{id}", path_parameters)
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[EmployeesGetResponse]:
        ...
        return await self.request_adapter.send_async(request_info, EmployeesGetResponse, error_mapping)
    ...
    async def put(self,body: Employee, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[EmployeesPutResponse]:
        ...
        return await self.request_adapter.send_async(request_info, EmployeesPutResponse, error_mapping)
    ...
    @property
    def reachability(self) -> ReachabilityRequestBuilder:
        """
        The reachability property
        """
        from .reachability.reachability_request_builder import ReachabilityRequestBuilder

        return ReachabilityRequestBuilder(self.request_adapter, self.path_parameters)
