...
if TYPE_CHECKING:
    from .......models.tns_l_l_m_model import TnsLLMModel
    from .......models.tns_l_l_m_provider import TnsLLMProvider

@dataclass
class ConfigsPutRequestBody(AdditionalDataHolder, Parsable):
    """
    ...
    # API-Key des Providers (wird verschlüsselt gespeichert)
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> ConfigsPutRequestBody:
        """
        Creates a new instance of the appropriate class based on discriminator value
        param parse_node: The parse node to use to read the discriminator value and create the object
        Returns: ConfigsPutRequestBody
        """
        if parse_node is None:
            raise TypeError("parse_node cannot be null.")
        return ConfigsPutRequestBody()
