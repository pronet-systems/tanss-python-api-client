...
if TYPE_CHECKING:
    from .readable_text_post_request_body_employee_ids import ReadableTextPostRequestBody_employeeIds

@dataclass
class ReadableTextPostRequestBody(AdditionalDataHolder, Parsable):
    # Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.
    additional_data: dict[str, Any] = field(default_factory=dict)

    # Identifiers of the employees assigned to the recurrence.
    employee_ids: Optional[list[ReadableTextPostRequestBody_employeeIds]] = None
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> ReadableTextPostRequestBody:
        """
        Creates a new instance of the appropriate class based on discriminator value
        param parse_node: The parse node to use to read the discriminator value and create the object
        Returns: ReadableTextPostRequestBody
        """
        if parse_node is None:
            raise TypeError("parse_node cannot be null.")
        return ReadableTextPostRequestBody()
    ...
    def get_field_deserializers(self,) -> dict[str, Callable[[ParseNode], None]]:
        ...
        fields: dict[str, Callable[[Any], None]] = {
            "employeeIds": lambda n : setattr(self, 'employee_ids', n.get_collection_of_object_values(ReadableTextPostRequestBody_employeeIds)),
