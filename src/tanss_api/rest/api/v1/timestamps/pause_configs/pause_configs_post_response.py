...
@dataclass
class PauseConfigsPostResponse(AdditionalDataHolder, Parsable):
    ...
    content: Optional[TimestampPauseConfig] = None
    # The meta property
    meta: Optional[TnsMetaMessage] = None
    
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> PauseConfigsPostResponse:
        """
        Creates a new instance of the appropriate class based on discriminator value
        param parse_node: The parse node to use to read the discriminator value and create the object
        Returns: PauseConfigsPostResponse
        """
        if parse_node is None:
            raise TypeError("parse_node cannot be null.")
        return PauseConfigsPostResponse()
    ...
    def get_field_deserializers(self,) -> dict[str, Callable[[ParseNode], None]]:
        ...
        fields: dict[str, Callable[[Any], None]] = {
            "content": lambda n : setattr(self, 'content', n.get_object_value(TimestampPauseConfig)),
