...
if TYPE_CHECKING:
    from .ticket_complete_attention import TicketComplete_attention
    from .ticket_complete_installation_fee import TicketComplete_installationFee
    from .ticket_complete_installation_fee_drive_mode import TicketComplete_installationFeeDriveMode
    from .ticket_complete_local_ticket_admin_flag import TicketComplete_localTicketAdminFlag
...
@dataclass
class TicketComplete(AdditionalDataHolder, Parsable):
    """
    ...
    attention: Optional[TicketComplete_attention] = None
    ...
    installation_fee: Optional[TicketComplete_installationFee] = None
    ...
    installation_fee_drive_mode: Optional[TicketComplete_installationFeeDriveMode] = None
    ...
    local_ticket_admin_flag: Optional[TicketComplete_localTicketAdminFlag] = None
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> TicketComplete:
        """
        Creates a new instance of the appropriate class based on discriminator value
        param parse_node: The parse node to use to read the discriminator value and create the object
        Returns: TicketComplete
        """
    ...
    def get_field_deserializers(self,) -> dict[str, Callable[[ParseNode], None]]:
        ...
        fields: dict[str, Callable[[Any], None]] = {
            ...
            "attention": lambda n : setattr(self, 'attention', n.get_enum_value(TicketComplete_attention)),
            ...
            "installationFee": lambda n : setattr(self, 'installation_fee', n.get_enum_value(TicketComplete_installationFee)),
            "installationFeeAmount": lambda n : setattr(self, 'installation_fee_amount', n.get_float_value()),
            "installationFeeDriveMode": lambda n : setattr(self, 'installation_fee_drive_mode', n.get_enum_value(TicketComplete_installationFeeDriveMode)),
            ...
            "localTicketAdminFlag": lambda n : setattr(self, 'local_ticket_admin_flag', n.get_enum_value(TicketComplete_localTicketAdminFlag)),
