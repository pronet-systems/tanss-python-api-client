...
if TYPE_CHECKING:
    from ......models.tns_service_call_type import TnsServiceCallType

@dataclass
class ServicesPutRequestBody(AdditionalDataHolder, Parsable):
    ...
    # The externalDirectory property
    external_directory: Optional[bool] = None
    # The symbol property
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> ServicesPutRequestBody:
        """
        Creates a new instance of the appropriate class based on discriminator value
        param parse_node: The parse node to use to read the discriminator value and create the object
        Returns: ServicesPutRequestBody
        """
        if parse_node is None:
            raise TypeError("parse_node cannot be null.")
        return ServicesPutRequestBody()
    ...
    def get_field_deserializers(self,) -> dict[str, Callable[[ParseNode], None]]:
        ...
        fields: dict[str, Callable[[Any], None]] = {
            ...
            "externalDirectory": lambda n : setattr(self, 'external_directory', n.get_bool_value()),
    ...
    def serialize(self,writer: SerializationWriter) -> None:
        ...
        writer.write_bool_value("externalDirectory", self.external_directory)
