...
class WithCompanyItemRequestBuilder(BaseRequestBuilder):
    """
    Builds and executes requests for operations under /api/v1/emailAccounts/company/{companyId}
    """
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/api/v1/emailAccounts/company/{companyId}", path_parameters)
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[WithCompanyGetResponse]:
        """
        Returns all email accounts assigned to the given company, with linkedentities (domain, contact employee, etc.) prefilled. Requires the`VIEW_EMAIL_ACCOUNTS_OF_CUSTOMER` permission and access to the company.Customer users do not call this route; only technicians or freelancers withthe matching permission see email accounts.
