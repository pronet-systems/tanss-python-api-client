...
class CompaniesRequestBuilder(BaseRequestBuilder):
    """
    Builds and executes requests for operations under /api/tanss.app/v1/companies
    """
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/api/tanss.app/v1/companies", path_parameters)
    
    def by_company_id(self,company_id: int) -> WithCompanyItemRequestBuilder:
        """
        Gets an item from the tanss_api.rest.api.tanssApp.v1.companies.item collection
