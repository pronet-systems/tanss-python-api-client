...
if TYPE_CHECKING:
    ...
    from .currencies_put_request_body import CurrenciesPutRequestBody
    from .currencies_put_response import CurrenciesPutResponse

class CurrenciesItemRequestBuilder(BaseRequestBuilder):
    """
    Builds and executes requests for operations under /api/v1/currencies/{id}
    """
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/api/v1/currencies/{id}", path_parameters)
    ...
    async def put(self,body: CurrenciesPutRequestBody, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[CurrenciesPutResponse]:
        """
        ...
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
        Returns: Optional[CurrenciesPutResponse]
        """
        if body is None:
        ...
        return await self.request_adapter.send_async(request_info, CurrenciesPutResponse, error_mapping)
    ...
    def to_put_request_information(self,body: CurrenciesPutRequestBody, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> RequestInformation:
        """
        Generic admin update endpoint. Applies the JSON patch to the entity addressed by `id` and persists it. Requires the corresponding admin permission (e.g. `MANAGE_ACCOUNTING_TYPES`, `BASE_DATA_MANAGEMENT_SYSTEM_TABLES`).
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    @dataclass
    class CurrenciesItemRequestBuilderDeleteRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
    ...
    @dataclass
    class CurrenciesItemRequestBuilderPutRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        warn("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.", DeprecationWarning)
