...
class WithCompanyItemRequestBuilder(BaseRequestBuilder):
    """
    Builds and executes requests for operations under /api/v1/tickets/company/{companyId}
    """
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/api/v1/tickets/company/{companyId}", path_parameters)
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[WithCompanyGetResponse]:
        """
        Returns all tickets associated with the given company. Intended forcustomer-facing portals or for technicians filtering their view by client.By default the result spans both open and closed tickets — use theconfigurable list endpoint (`PUT /api/v1/tickets`) if you need statefilters, pagination, or sort options.
