...
class TextmodulesRequestBuilder(BaseRequestBuilder):
    """
    Builds and executes requests for operations under /api/v1/util/textmodules
    """
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/api/v1/util/textmodules", path_parameters)
    
    def by_type(self,type: int) -> WithTypeItemRequestBuilder:
        """
        Gets an item from the tanss_api.rest.api.v1.util.textmodules.item collection
        param type: Text module type to list (e.g. mail or ticket signatures).
