...
class StatusRequestBuilder(BaseRequestBuilder):
    """
    Builds and executes requests for operations under /api/v1/projects/{projectId}/status
    """
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/api/v1/projects/{projectId}/status", path_parameters)
    
    async def get(self,request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[StatusGetResponse]:
        """
        Returns aggregated status information for a project — overall progress, numberof open vs. done sub-tickets, budget consumption — used to render the projectheader KPIs. Requires the caller to be a technician or freelancer and to haveaccess to the project.
