...
class AssignmentRequestBuilder(BaseRequestBuilder):
    """
    Builds and executes requests for operations under /api/erp/v1/checklists/assignment
    """
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/api/erp/v1/checklists/assignment", path_parameters)
    
    def by_link_type_id(self,link_type_id: int) -> WithLinkTypeItemRequestBuilder:
        """
        Gets an item from the tanss_api.rest.api.erp.v1.checklists.assignment.item collection
        param link_type_id: linkTypeId (11 = ticket)
