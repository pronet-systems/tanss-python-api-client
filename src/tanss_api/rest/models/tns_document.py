...
@dataclass
class TnsDocument(AdditionalDataHolder, Parsable):
    """
    a company document
    """
    ...
    type: Optional[TnsDocumentTypeEnum] = None
    
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> TnsDocument:
        """
    ...
    def get_field_deserializers(self,) -> dict[str, Callable[[ParseNode], None]]:
        ...
        fields: dict[str, Callable[[Any], None]] = {
            ...
            "modificationDate": lambda n : setattr(self, 'modification_date', n.get_int_value()),
            "name": lambda n : setattr(self, 'name', n.get_str_value()),
            "type": lambda n : setattr(self, 'type', n.get_enum_value(TnsDocumentTypeEnum)),
        }
        return fields
