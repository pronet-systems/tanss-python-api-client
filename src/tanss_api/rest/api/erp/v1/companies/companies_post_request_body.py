...
@dataclass
class CompaniesPostRequestBody(AdditionalDataHolder, Parsable):
    """
    Request body.
    """
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> CompaniesPostRequestBody:
        """
        ...
        return CompaniesPostRequestBody()
