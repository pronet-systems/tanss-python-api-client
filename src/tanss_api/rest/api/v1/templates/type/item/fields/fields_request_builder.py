...
class FieldsRequestBuilder(BaseRequestBuilder):
    """
    Builds and executes requests for operations under /api/v1/templates/type/{templateType}/fields
    """
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/api/v1/templates/type/{templateType}/fields", path_parameters)
    
    async def get(self,request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[FieldsGetResponse]:
        """
        Returns the catalogue of fields available for templates of `templateType` (TICKET, CONTRACT, DEVICE, ...).Each field declaration tells the editor which key, label, data type, and group it belongs to, so the UI canrender the "fields to include" checklist when saving a new template.
