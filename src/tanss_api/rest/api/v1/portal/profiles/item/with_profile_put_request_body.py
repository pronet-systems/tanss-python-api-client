...
if TYPE_CHECKING:
    ...
    from .with_profile_put_request_body_items import WithProfilePutRequestBody_items

@dataclass
class WithProfilePutRequestBody(AdditionalDataHolder, Parsable):
    """
    Zu ändernde Felder des Profils (Merge) inkl. vollständiger Item-Liste
    """
    ...
    # The items property
    items: Optional[list[WithProfilePutRequestBody_items]] = None
    # The name property
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> WithProfilePutRequestBody:
        """
        Creates a new instance of the appropriate class based on discriminator value
        param parse_node: The parse node to use to read the discriminator value and create the object
        Returns: WithProfilePutRequestBody
        """
        if parse_node is None:
            raise TypeError("parse_node cannot be null.")
        return WithProfilePutRequestBody()
    ...
    def get_field_deserializers(self,) -> dict[str, Callable[[ParseNode], None]]:
        ...
        fields: dict[str, Callable[[Any], None]] = {
            ...
            "items": lambda n : setattr(self, 'items', n.get_collection_of_object_values(WithProfilePutRequestBody_items)),
