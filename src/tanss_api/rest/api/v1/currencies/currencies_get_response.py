...
if TYPE_CHECKING:
    ...
    from .currencies_get_response_content import CurrenciesGetResponse_content
...
class CurrenciesGetResponse(AdditionalDataHolder, Parsable):
    ...
    content: Optional[list[CurrenciesGetResponse_content]] = None
    # The meta property
    ...
    def get_field_deserializers(self,) -> dict[str, Callable[[ParseNode], None]]:
        ...
        fields: dict[str, Callable[[Any], None]] = {
            "content": lambda n : setattr(self, 'content', n.get_collection_of_object_values(CurrenciesGetResponse_content)),
