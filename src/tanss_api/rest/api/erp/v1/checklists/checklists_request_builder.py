...
if TYPE_CHECKING:
    from .....models.checklists403_error import Checklists403Error
...
class ChecklistsRequestBuilder(BaseRequestBuilder):
    """
    Builds and executes requests for operations under /api/erp/v1/checklists
    """
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/api/erp/v1/checklists{?companyId*,departmentId*}", path_parameters)
