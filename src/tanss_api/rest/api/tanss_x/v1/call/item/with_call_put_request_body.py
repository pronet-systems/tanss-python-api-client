...
@dataclass
class WithCallPutRequestBody(AdditionalDataHolder, Parsable):
    ...
    # The fromCompanyPercent property
    from_company_percent: Optional[int] = None
    ...
    # The numberIdentifyState property
    ...
    # The telephoneSystemId property
    telephone_system_id: Optional[int] = None
    # The toCompanyId property
    to_company_id: Optional[int] = None
    # The toCompanyPercent property
    to_company_percent: Optional[int] = None
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> WithCallPutRequestBody:
        """
        Creates a new instance of the appropriate class based on discriminator value
        param parse_node: The parse node to use to read the discriminator value and create the object
        Returns: WithCallPutRequestBody
        """
        if parse_node is None:
            raise TypeError("parse_node cannot be null.")
        return WithCallPutRequestBody()
    ...
    def get_field_deserializers(self,) -> dict[str, Callable[[ParseNode], None]]:
        ...
        fields: dict[str, Callable[[Any], None]] = {
            ...
            "fromCompanyPercent": lambda n : setattr(self, 'from_company_percent', n.get_int_value()),
            ...
            "toCompanyPercent": lambda n : setattr(self, 'to_company_percent', n.get_int_value()),
    ...
    def serialize(self,writer: SerializationWriter) -> None:
        ...
        writer.write_int_value("fromCompanyPercent", self.from_company_percent)
        ...
        writer.write_int_value("toCompanyPercent", self.to_company_percent)
