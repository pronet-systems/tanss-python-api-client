...
if TYPE_CHECKING:
    from .item.components_item_request_builder import ComponentsItemRequestBuilder
...
class ComponentsRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/api/deviceManagement/v1/components", path_parameters)
    
    def by_id(self,id: int) -> ComponentsItemRequestBuilder:
        """
        Gets an item from the tanss_api.rest.api.deviceManagement.v1.components.item collection
        ...
        return ComponentsItemRequestBuilder(self.request_adapter, url_tpl_params)
