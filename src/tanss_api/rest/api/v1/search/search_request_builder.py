...
class SearchRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/api/v1/search", path_parameters)
    ...
    async def put(self,body: TnsSearchConfiguration, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[SearchPutResponse]:
        ...
        return await self.request_adapter.send_async(request_info, SearchPutResponse, error_mapping)
