...
if TYPE_CHECKING:
    from .email_settings_put_request_body_assignment_type import EmailSettingsPutRequestBody_assignmentType
    from .email_settings_put_request_body_pop3_type import EmailSettingsPutRequestBody_pop3Type
    from .email_settings_put_request_body_smtp_type import EmailSettingsPutRequestBody_smtpType

@dataclass
class EmailSettingsPutRequestBody(AdditionalDataHolder, Parsable):
    """
    Request body.
    """
    ...
    assignment_type: Optional[EmailSettingsPutRequestBody_assignmentType] = None
    ...
    pop3_type: Optional[EmailSettingsPutRequestBody_pop3Type] = None
    ...
    smtp_type: Optional[EmailSettingsPutRequestBody_smtpType] = None
    
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> EmailSettingsPutRequestBody:
        """
        Creates a new instance of the appropriate class based on discriminator value
        param parse_node: The parse node to use to read the discriminator value and create the object
        Returns: EmailSettingsPutRequestBody
        """
        if parse_node is None:
            raise TypeError("parse_node cannot be null.")
        return EmailSettingsPutRequestBody()
    ...
    def get_field_deserializers(self,) -> dict[str, Callable[[ParseNode], None]]:
        ...
        fields: dict[str, Callable[[Any], None]] = {
            ...
            "assignmentType": lambda n : setattr(self, 'assignment_type', n.get_enum_value(EmailSettingsPutRequestBody_assignmentType)),
            "id": lambda n : setattr(self, 'id', n.get_int_value()),
            "name": lambda n : setattr(self, 'name', n.get_str_value()),
            "pop3Host": lambda n : setattr(self, 'pop3_host', n.get_str_value()),
            "pop3Type": lambda n : setattr(self, 'pop3_type', n.get_enum_value(EmailSettingsPutRequestBody_pop3Type)),
            ...
            "smtpType": lambda n : setattr(self, 'smtp_type', n.get_enum_value(EmailSettingsPutRequestBody_smtpType)),
        }
        return fields
