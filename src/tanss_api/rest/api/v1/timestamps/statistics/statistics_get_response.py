...
if TYPE_CHECKING:
    from .....models.timestamp_info_with_history import TimestampInfoWithHistory
...
class StatisticsGetResponse(AdditionalDataHolder, Parsable):
    ...
    content: Optional[list[TimestampInfoWithHistory]] = None
    # The meta property
    ...
    def get_field_deserializers(self,) -> dict[str, Callable[[ParseNode], None]]:
        ...
        fields: dict[str, Callable[[Any], None]] = {
            "content": lambda n : setattr(self, 'content', n.get_collection_of_object_values(TimestampInfoWithHistory)),
