...
class TimersItemRequestBuilder(BaseRequestBuilder):
    """
    Builds and executes requests for operations under /api/tanss.x/v1/timers/{id}
    """
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/api/tanss.x/v1/timers/{id}", path_parameters)
    ...
    async def delete(self,request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[TimersDeleteResponse]:
        """
        Löscht einen Timer samt allen Fragmenten. Nicht in der offiziellen Schnittstellenbeschreibung gefuehrt; vom Server so umgesetzt, gegen 10.10 geprueft. Token: module, Rollen TANSS_APP. Rechte: eigener Timer oder VIEW_TIMERS_OF_ALL_TECHNICIANS; Firmenzugriff. Hinweise: Auch unter /api/tanss.app/v1. 404 ENTITY_NOT_FOUND. Es wird nur der Lese-Check geprüft (VIEW_TIMERS_OF_ALL_TECHNICIANS), nicht DELETE_TIMERS_OF_ALL_TECHNICIANS. Erzeugt Log-Eintrag. meta.status DELETED.
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[TimersGetResponse]:
        """
        Liefert einen Timer (ohne Fragmente). Nicht in der offiziellen Schnittstellenbeschreibung gefuehrt; vom Server so umgesetzt, gegen 10.10 geprueft. Token: module, Rollen TANSS_APP. Rechte: eigener Timer oder VIEW_TIMERS_OF_ALL_TECHNICIANS; Firmenzugriff. Hinweise: Auch unter /api/tanss.app/v1. 404 ENTITY_NOT_FOUND; 403 FORBIDDEN_NO_ENTITY_ACCESS.
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    async def put(self,request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[TimersPutResponse]:
        """
        Startet bzw. stoppt einen Timer (Toggle): läuft er (startTime>0), wird gestoppt und die Dauer aufaddiert, sonst wird ein neues Fragment gestartet. Nicht in der offiziellen Schnittstellenbeschreibung gefuehrt; vom Server so umgesetzt, gegen 10.10 geprueft. Token: module, Rollen TANSS_APP. Hinweise: Auch unter /api/tanss.app/v1. Kein Request-Body. 400 OBJECT_NOT_FOUND wenn Timer fehlt. Beim Stopp wird stopTime des letzten Fragments gesetzt. Kein Rechte-Check. meta.status UPDATED.
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
