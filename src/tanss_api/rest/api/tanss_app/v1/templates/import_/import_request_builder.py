...
class ImportRequestBuilder(BaseRequestBuilder):
    """
    Builds and executes requests for operations under /api/tanss.app/v1/templates/import
    """
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/api/tanss.app/v1/templates/import", path_parameters)
    ...
    async def post(self,body: ImportPostRequestBody, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[ImportPostResponse]:
        """
        Legt einen ausstehenden Vorlagen-Import (TnsPendingImport) an, der spaeter in TANSS importiert werden kann. Nicht in der offiziellen Schnittstellenbeschreibung gefuehrt; vom Server so umgesetzt, gegen 10.10 geprueft. Token: module, Rollen TANSS_APP. Rechte: interner Benutzertyp; bet.EDIT_ALL_PROCESSES. Hinweise: date/importDate/importEmployeeId werden serverseitig gesetzt. Status CREATED. Auch unter /api/tanss.x/v1.
