...
class CopyRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/api/v1/checklists/copy", path_parameters)
    
    def by_checklist_id(self,checklist_id: int) -> WithChecklistItemRequestBuilder:
        """
        Gets an item from the tanss_api.rest.api.v1.checklists.copy.item collection
        param checklist_id: ID of the checklist to copy.
